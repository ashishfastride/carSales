...
public class Ccomponents extends JPanel{
	...
	JTextField  mfg= new JTextField(40);
	JTextField  yer= new JTextField(40);
	JTextField  mod= new JTextField(40);
	JTextField  prc= new JTextField(40);
	JTextField  tKm= new JTextField(40);
	JTextArea  eInfo= new JTextArea(3,40);
